...
class charClass {
    init(namecall: String, maxhit_points: Int, mana_points: Int, strg: Int, spd: Int, mag: Int, dfense: Int, turn_num: Int, turn_wait: Int, exp: Int, lev: Int, hit_points: Int) {
        self.name = namecall
...
'''
while True:
e1 = enemy('Troll', ehp, 100, random.randint(50, 80), random.randint(3, 5), random.randint(10, 40), random.randint(1, 5), 1, 0, 0, 1, ehp)
