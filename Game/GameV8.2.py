...
class charClass:
    def __init__(self, namecall, hit_points, mana_points, strg, spd, mag, dfense, turn_num, turn_wait, exp, lev):
        self.name = namecall
        self.hp = hit_points
        self.mp = mana_points
        self.strength = strg
...
class knight(charClass):
    def __init__(self, namecall, hit_points, mana_points, strg, spd, mag, dfense, turn_num, turn_wait, exp, lev):
        super().__init__(namecall, hit_points, mana_points, strg, spd, mag, dfense, turn_num, turn_wait, exp, lev)
...
CHARACTER CHOOSING
'''
z = knight('Knighty', 300, 0, 40, 4, 0, 5, 1, 0, 0, 1)
b = mage('Magey', 200, 100, 10, 4, 40, 2, 1, 0, 0, 1)
c = brute('Brutey', 250, 15, 50, 3, 10, 5, 1, 0, 0, 1)

'''
BATTLE SYSTEM
'''
while True:
    e1 = enemy('enemy', random.randint(250,400), 100, random.randint(50, 80), random.randint(3, 5), random.randint(10, 40), random.randint(1, 5), 1, 0, 0, 1)
